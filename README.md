...
## 1. Класс `ShopDbContext`
- **Назначение:** Основной класс для работы с базой данных
- **Функционал:**
  - Управление подключением к базе данных
  - Предоставление доступа к DbSet коллекциям для всех сущностей
  - Реализация миграций и обновлений схемы базы данных
...
- **Функционал:**
  ...
  - Управление консольным интерфейсом
  - Обработка пользовательского ввода
  - Маршрутизация между различными ролями (админ, продавец, покупатель)
